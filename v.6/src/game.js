...
class Gui{
    constructor(){
        this.HP = 3;
        this.score = 0;
        gui.innerHTML += '<div class="hp" id="hp"></div>';
        gui.innerHTML += '<div class="score" id="score"></div>';
        gui.innerHTML += '<div class="blur"></div>';
        gui.innerHTML += '<div class="start"><button onclick="reset()">Start</button></div>';
    ...
    update(HP, score){
        ...
        this.hpElem = document.getElementById("hp");
        this.scoreElem = document.getElementById("score");
        this.hpElem.innerHTML = "Hp: " + this.HP;
